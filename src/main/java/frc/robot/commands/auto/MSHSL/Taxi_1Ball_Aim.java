...
public class Taxi_1Ball_Aim extends SequentialCommandGroup {
   ...
   */
  public Taxi_1Ball_Aim(Drivetrain driveSS, 
    ...
    addCommands(
      new ZeroNavX(m_navx),
      new ParallelCommandGroup(new DriveGyroDistance(45, 0.7, m_drivetrain, m_navx), new IntakeDeploy(m_intakeActuate, 300)),
      ...
      new ShootSpinUp(m_common, m_flywheels, m_limelight, 3000),
      new ParallelCommandGroup(new ShootSpinUp(m_common, m_flywheels, m_limelight, 3000), new ShootAssist(m_common, m_limelight, m_kicker, m_intakeCenterer, m_intakeRoller, m_ods, 7000)));
  }
}
