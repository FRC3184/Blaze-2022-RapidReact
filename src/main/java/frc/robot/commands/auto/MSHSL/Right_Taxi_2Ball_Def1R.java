...
public class Right_Taxi_2Ball_Def1R extends SequentialCommandGroup {
   ...
   */
  public Right_Taxi_2Ball_Def1R(Drivetrain driveSS, 
    ...
    addCommands(
        ...
        // // drive back to goal
        new ZeroNavX(m_navx),
        new TurnGyroPIDTimeout(15, m_drivetrain, navx, 750),
        ...
        new ZeroNavX(m_navx),
        new TurnGyroPIDTimeout(-87, m_drivetrain, m_navx, 1000),
