...
public class Left_Taxi_1Ball extends SequentialCommandGroup {
   ...
   */
  public Left_Taxi_1Ball(Drivetrain driveSS, Shooter_Flywheels flywheelsSS, Shooter_Kicker kickerSS) {
