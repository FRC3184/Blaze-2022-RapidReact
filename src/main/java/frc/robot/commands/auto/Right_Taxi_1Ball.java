...
public class Right_Taxi_1Ball extends SequentialCommandGroup {
   ...
   */
  public Right_Taxi_1Ball(Drivetrain driveSS, Shooter_Flywheels flywheelsSS, Shooter_Kicker kickerSS) {
